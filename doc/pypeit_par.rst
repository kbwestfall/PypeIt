...
The nesting of the PypeIt parameters is as illustrated in the :ref:`par-hierarchy`
section below.  Here are a few examples of how to change
...
Parameter Hierarchy and Definition Tables
=========================================

.. dropdown:: Current PypeItPar Parameter Hierarchy
   :name: par-hierarchy
...
.. dropdown:: PypeItPar Parameters
   :name: pypeitpar
    ...
    ================  ===============================================  =======  =======================  ======================================================================================================================================================================================================================================================================================
    ``calibrations``  :class:`~pypeit.par.pypeitpar.CalibrationsPar`   ..       :ref:`calibrationspar`   Parameters for the calibration algorithms                                                                                                                                                                                                                                             
    ``coadd1d``       :class:`~pypeit.par.pypeitpar.Coadd1DPar`        ..       :ref:`coadd1dpar`        Par set to control 1D coadds.  Only used in the after-burner script.                                                                                                                                                                                                                  
    ``coadd2d``       :class:`~pypeit.par.pypeitpar.Coadd2DPar`        ..       :ref:`coadd2dpar`        Par set to control 2D coadds.  Only used in the after-burner script.                                                                                                                                                                                                                  
    ``collate1d``     :class:`~pypeit.par.pypeitpar.Collate1DPar`      ..       :ref:`collate1dpar`      Par set to control collating 1d spectra.  Only used in the after-burner script.                                                                                                                                                                                                       
    ``flexure``       :class:`~pypeit.par.pypeitpar.FlexurePar`        ..       :ref:`flexurepar`        Parameters used by the flexure-correction procedure.  Flexure corrections are not performed by default.  To turn on, either set the parameters in the 'flexure' parameter group or set 'flexure = True' in the 'rdx' parameter group to use the default flexure-correction parameters.
    ``fluxcalib``     :class:`~pypeit.par.pypeitpar.FluxCalibratePar`  ..       :ref:`fluxcalibratepar`  Parameters used by the flux-calibration procedure.  Flux calibration is not performed by default.  To turn on, either set the parameters in the 'fluxcalib' parameter group or set 'fluxcalib = True' in the 'rdx' parameter group to use the default flux-calibration parameters.    
    ``rdx``           :class:`~pypeit.par.pypeitpar.ReduxPar`          ..       :ref:`reduxpar`          PypeIt reduction rules.                                                                                                                                                                                                                                                               
    ``reduce``        :class:`~pypeit.par.pypeitpar.ReducePar`         ..       :ref:`reducepar`         Parameters determining sky-subtraction, object finding, and extraction                                                                                                                                                                                                                
    ``scienceframe``  :class:`~pypeit.par.pypeitpar.FrameGroupPar`     ..       :ref:`framegrouppar`     The frames and combination rules for the science observations                                                                                                                                                                                                                         
    ``sensfunc``      :class:`~pypeit.par.pypeitpar.SensFuncPar`       ..       :ref:`sensfuncpar`       Par set to control sensitivity function computation.  Only used in the after-burner script.                                                                                                                                                                                           
    ``telluric``      :class:`~pypeit.par.pypeitpar.TelluricPar`       ..       :ref:`telluricpar`       Par set to control telluric fitting.  Only used in the pypeit_sensfunc and pypeit_telluric after-burner scripts.                                                                                                                                                                      
    ================  ===============================================  =======  =======================  ======================================================================================================================================================================================================================================================================================



.. dropdown:: CalibrationsPar Parameters
   :name: calibrationspar
    ...
    Key                        Type                                                  Options  Default                       Description                                                                                                                                                                                                                                      
    =========================  ====================================================  =======  ============================  =================================================================================================================================================================================================================================================
    ``alignframe``             :class:`~pypeit.par.pypeitpar.FrameGroupPar`          ..       :ref:`framegrouppar`          The frames and combination rules for the align frames                                                                                                                                                                                            
    ``alignment``              :class:`~pypeit.par.pypeitpar.AlignPar`               ..       :ref:`alignpar`               Define the procedure for the alignment of traces                                                                                                                                                                                                 
    ``arcframe``               :class:`~pypeit.par.pypeitpar.FrameGroupPar`          ..       :ref:`framegrouppar`          The frames and combination rules for the wavelength calibration                                                                                                                                                                                  
    ``biasframe``              :class:`~pypeit.par.pypeitpar.FrameGroupPar`          ..       :ref:`framegrouppar`          The frames and combination rules for the bias correction                                                                                                                                                                                         
    ...
    ``darkframe``              :class:`~pypeit.par.pypeitpar.FrameGroupPar`          ..       :ref:`framegrouppar`          The frames and combination rules for the dark-current correction                                                                                                                                                                                 
    ``flatfield``              :class:`~pypeit.par.pypeitpar.FlatFieldPar`           ..       :ref:`flatfieldpar`           Parameters used to set the flat-field procedure                                                                                                                                                                                                  
    ``illumflatframe``         :class:`~pypeit.par.pypeitpar.FrameGroupPar`          ..       :ref:`framegrouppar`          The frames and combination rules for the illumination flat                                                                                                                                                                                       
    ``lampoffflatsframe``      :class:`~pypeit.par.pypeitpar.FrameGroupPar`          ..       :ref:`framegrouppar`          The frames and combination rules for the lamp off flats                                                                                                                                                                                          
    ``pinholeframe``           :class:`~pypeit.par.pypeitpar.FrameGroupPar`          ..       :ref:`framegrouppar`          The frames and combination rules for the pinholes                                                                                                                                                                                                
    ``pixelflatframe``         :class:`~pypeit.par.pypeitpar.FrameGroupPar`          ..       :ref:`framegrouppar`          The frames and combination rules for the pixel flat                                                                                                                                                                                              
    ...
    ``scattlightframe``        :class:`~pypeit.par.pypeitpar.FrameGroupPar`          ..       :ref:`framegrouppar`          The frames and combination rules for the scattered light frames                                                                                                                                                                                  
    ``skyframe``               :class:`~pypeit.par.pypeitpar.FrameGroupPar`          ..       :ref:`framegrouppar`          The frames and combination rules for the sky background observations                                                                                                                                                                             
    ``slitedges``              :class:`~pypeit.par.pypeitpar.EdgeTracePar`           ..       :ref:`edgetracepar`           Slit-edge tracing parameters                                                                                                                                                                                                                     
    ``slitless_pixflatframe``  :class:`~pypeit.par.pypeitpar.FrameGroupPar`          ..       :ref:`framegrouppar`          The frames and combination rules for the slitless pixel flat                                                                                                                                                                                     
    ``standardframe``          :class:`~pypeit.par.pypeitpar.FrameGroupPar`          ..       :ref:`framegrouppar`          The frames and combination rules for the spectrophotometric standard observations                                                                                                                                                                
    ``tiltframe``              :class:`~pypeit.par.pypeitpar.FrameGroupPar`          ..       :ref:`framegrouppar`          The frames and combination rules for the wavelength tilts                                                                                                                                                                                        
    ``tilts``                  :class:`~pypeit.par.pypeitpar.WaveTiltsPar`           ..       :ref:`wavetiltspar`           Define how to trace the slit tilts using the trace frames                                                                                                                                                                                        
    ``traceframe``             :class:`~pypeit.par.pypeitpar.FrameGroupPar`          ..       :ref:`framegrouppar`          The frames and combination rules for images used for slit tracing                                                                                                                                                                                
    ``wavelengths``            :class:`~pypeit.par.pypeitpar.WavelengthSolutionPar`  ..       :ref:`wavelengthsolutionpar`  Parameters used to derive the wavelength solution                                                                                                                                                                                                
    =========================  ====================================================  =======  ============================  =================================================================================================================================================================================================================================================



.. dropdown:: AlignPar Parameters
   :name: alignpar
...
.. dropdown:: FlatFieldPar Parameters
   :name: flatfieldpar
...
.. dropdown:: EdgeTracePar Parameters
   :name: edgetracepar
...
.. dropdown:: WaveTiltsPar Parameters
   :name: wavetiltspar
...
.. dropdown:: WavelengthSolutionPar Parameters
   :name: wavelengthsolutionpar
...
.. dropdown:: Coadd1DPar Parameters
   :name: coadd1dpar
...
.. dropdown:: Coadd2DPar Parameters
   :name: coadd2dpar
...
.. dropdown:: Collate1DPar Parameters
   :name: collate1dpar
...
.. dropdown:: FlexurePar Parameters
   :name: flexurepar
...
.. dropdown:: FluxCalibratePar Parameters
   :name: fluxcalibratepar
...
.. dropdown:: ReducePar Parameters
   :name: reducepar
    ...
    Key             Type                                          Options  Default               Description                                                                      
    ==============  ============================================  =======  ====================  =================================================================================
    ``cube``        :class:`~pypeit.par.pypeitpar.CubePar`        ..       :ref:`cubepar`        Parameters for cube generation algorithms                                        
    ``extraction``  :class:`~pypeit.par.pypeitpar.ExtractionPar`  ..       :ref:`extractionpar`  Parameters for extraction algorithms                                             
    ``findobj``     :class:`~pypeit.par.pypeitpar.FindObjPar`     ..       :ref:`findobjpar`     Parameters for the find object and tracing algorithms                            
    ``skysub``      :class:`~pypeit.par.pypeitpar.SkySubPar`      ..       :ref:`skysubpar`      Parameters for sky subtraction algorithms                                        
    ``slitmask``    :class:`~pypeit.par.pypeitpar.SlitMaskPar`    ..       :ref:`slitmaskpar`    Parameters for slitmask                                                          
    ``trim_edge``   list                                          ..       3, 3                  Trim the slit by this number of pixels left/right when performing sky subtraction
    ==============  ============================================  =======  ====================  =================================================================================



.. dropdown:: CubePar Parameters
   :name: cubepar
...
.. dropdown:: ExtractionPar Parameters
   :name: extractionpar
...
.. dropdown:: FindObjPar Parameters
   :name: findobjpar
...
.. dropdown:: SlitMaskPar Parameters
   :name: slitmaskpar
...
.. dropdown:: FrameGroupPar Parameters
   :name: framegrouppar
    ...
    ``process``    :class:`~pypeit.par.pypeitpar.ProcessImagesPar`  ..                                                                                                                                                                                                  :ref:`processimagespar`  Low level parameters used for basic image processing                                                                                                                                                                                                           
    ``useframe``   str                                              ..                                                                                                                                                                                                  ..                       A calibrations file to use if it exists.                                                                                                                                                                                                                       
    =============  ===============================================  ==================================================================================================================================================================================================  =======================  ===============================================================================================================================================================================================================================================================



.. dropdown:: ProcessImagesPar Parameters
   :name: processimagespar
    ...
    ``scattlight``              :class:`~pypeit.par.pypeitpar.ScatteredLightPar`  ..                                                                   :ref:`scatteredlightpar`  Scattered light subtraction parameters.                                                                                                                                                                                                                                                                                                                                                 
...
.. dropdown:: ScatteredLightPar Parameters
   :name: scatteredlightpar
...
.. dropdown:: SensFuncPar Parameters
   :name: sensfuncpar
    ...
    Key                      Type                                            Options           Default                 Description                                                                                                                                                                                                                                                                                                                                                                                 
    =======================  ==============================================  ================  ======================  ============================================================================================================================================================================================================================================================================================================================================================================================
    ``IR``                   :class:`~pypeit.par.pypeitpar.TelluricPar`      ..                :ref:`telluricpar`      Parameters for the IR sensfunc algorithm                                                                                                                                                                                                                                                                                                                                                    
    ``UVIS``                 :class:`~pypeit.par.pypeitpar.SensfuncUVISPar`  ..                :ref:`sensfuncuvispar`  Parameters for the UVIS sensfunc algorithm                                                                                                                                                                                                                                                                                                                                                  
...
.. dropdown:: SensfuncUVISPar Parameters
   :name: sensfuncuvispar
...
.. dropdown:: TelluricPar Parameters
   :name: telluricpar
...
.. dropdown:: AAT UHRF (``aat_uhrf``)
   :name: instr_par-aat_uhrf
...
.. dropdown:: BOK BC (``bok_bc``)
   :name: instr_par-bok_bc
...
.. dropdown:: GEMINI-S FLAMINGOS (``gemini_flamingos1``)
   :name: instr_par-gemini_flamingos1
...
.. dropdown:: GEMINI-S FLAMINGOS (``gemini_flamingos2``)
   :name: instr_par-gemini_flamingos2
...
.. dropdown:: GEMINI-N GMOS-N (``gemini_gmos_north_e2v``)
   :name: instr_par-gemini_gmos_north_e2v
...
.. dropdown:: GEMINI-N GMOS-N (``gemini_gmos_north_ham``)
   :name: instr_par-gemini_gmos_north_ham
...
.. dropdown:: GEMINI-N GMOS-N (``gemini_gmos_north_ham_ns``)
   :name: instr_par-gemini_gmos_north_ham_ns
...
.. dropdown:: GEMINI-S GMOS-S (``gemini_gmos_south_ham``)
   :name: instr_par-gemini_gmos_south_ham
...
.. dropdown:: GEMINI-N GNIRS (``gemini_gnirs_echelle``)
   :name: instr_par-gemini_gnirs_echelle
...
.. dropdown:: GEMINI-N GNIRS (``gemini_gnirs_ifu``)
   :name: instr_par-gemini_gnirs_ifu
...
.. dropdown:: GTC OSIRIS (``gtc_maat``)
   :name: instr_par-gtc_maat
...
.. dropdown:: GTC OSIRIS (``gtc_osiris``)
   :name: instr_par-gtc_osiris
...
.. dropdown:: GTC OSIRIS (``gtc_osiris_plus``)
   :name: instr_par-gtc_osiris_plus
...
.. dropdown:: JWST NIRCAM (``jwst_nircam``)
   :name: instr_par-jwst_nircam
...
.. dropdown:: JWST NIRSPEC (``jwst_nirspec``)
   :name: instr_par-jwst_nirspec
...
.. dropdown:: KECK DEIMOS (``keck_deimos``)
   :name: instr_par-keck_deimos
...
.. dropdown:: KECK ESI (``keck_esi``)
   :name: instr_par-keck_esi
...
.. dropdown:: KECK HIRES (``keck_hires``)
   :name: instr_par-keck_hires
...
.. dropdown:: KECK KCRM (``keck_kcrm``)
   :name: instr_par-keck_kcrm
...
.. dropdown:: KECK KCWI (``keck_kcwi``)
   :name: instr_par-keck_kcwi
...
.. dropdown:: KECK LRISb (``keck_lris_blue``)
   :name: instr_par-keck_lris_blue
...
.. dropdown:: KECK LRISb (``keck_lris_blue_orig``)
   :name: instr_par-keck_lris_blue_orig
...
.. dropdown:: KECK LRISr (``keck_lris_red``)
   :name: instr_par-keck_lris_red
...
.. dropdown:: KECK LRISr (``keck_lris_red_mark4``)
   :name: instr_par-keck_lris_red_mark4
...
.. dropdown:: KECK LRISr (``keck_lris_red_orig``)
   :name: instr_par-keck_lris_red_orig
...
.. dropdown:: KECK MOSFIRE (``keck_mosfire``)
   :name: instr_par-keck_mosfire
...
.. dropdown:: KECK NIRES (``keck_nires``)
   :name: instr_par-keck_nires
...
.. dropdown:: KECK NIRSPEC (``keck_nirspec_high``)
   :name: instr_par-keck_nirspec_high
...
.. dropdown:: KECK NIRSPEC (``keck_nirspec_high_old``)
   :name: instr_par-keck_nirspec_high_old
...
.. dropdown:: KECK NIRSPEC (``keck_nirspec_low``)
   :name: instr_par-keck_nirspec_low
...
.. dropdown:: LBT LUCI1 (``lbt_luci1``)
   :name: instr_par-lbt_luci1
...
.. dropdown:: LBT LUCI2 (``lbt_luci2``)
   :name: instr_par-lbt_luci2
...
.. dropdown:: LBT MODS1B (``lbt_mods1b``)
   :name: instr_par-lbt_mods1b
...
.. dropdown:: LBT MODS1R (``lbt_mods1r``)
   :name: instr_par-lbt_mods1r
...
.. dropdown:: LBT MODS2B (``lbt_mods2b``)
   :name: instr_par-lbt_mods2b
...
.. dropdown:: LBT MODS2R (``lbt_mods2r``)
   :name: instr_par-lbt_mods2r
...
.. dropdown:: LDT DeVeny (``ldt_deveny``)
   :name: instr_par-ldt_deveny
...
.. dropdown:: MAGELLAN FIRE (``magellan_fire``)
   :name: instr_par-magellan_fire
...
.. dropdown:: MAGELLAN FIRE (``magellan_fire_long``)
   :name: instr_par-magellan_fire_long
...
.. dropdown:: MAGELLAN MagE (``magellan_mage``)
   :name: instr_par-magellan_mage
...
.. dropdown:: HILTNER Echelle (``mdm_modspec``)
   :name: instr_par-mdm_modspec
...
.. dropdown:: HILTNER MDM4K (``mdm_osmos_mdm4k``)
   :name: instr_par-mdm_osmos_mdm4k
...
.. dropdown:: HILTNER R4K (``mdm_osmos_r4k``)
   :name: instr_par-mdm_osmos_r4k
...
.. dropdown:: MMT BINOSPEC (``mmt_binospec``)
   :name: instr_par-mmt_binospec
...
.. dropdown:: MMT Blue_Channel (``mmt_bluechannel``)
   :name: instr_par-mmt_bluechannel
...
.. dropdown:: MMT MMIRS (``mmt_mmirs``)
   :name: instr_par-mmt_mmirs
...
.. dropdown:: NOT ALFOSC (``not_alfosc``)
   :name: instr_par-not_alfosc
...
.. dropdown:: NOT ALFOSC (``not_alfosc_vert``)
   :name: instr_par-not_alfosc_vert
...
.. dropdown:: NTT EFOSC2 (``ntt_efosc2``)
   :name: instr_par-ntt_efosc2
...
.. dropdown:: P200 DBSPb (``p200_dbsp_blue``)
   :name: instr_par-p200_dbsp_blue
...
.. dropdown:: P200 DBSPr (``p200_dbsp_red``)
   :name: instr_par-p200_dbsp_red
...
.. dropdown:: P200 TSPEC (``p200_tspec``)
   :name: instr_par-p200_tspec
...
.. dropdown:: SHANE KASTb (``shane_kast_blue``)
   :name: instr_par-shane_kast_blue
...
.. dropdown:: SHANE KASTr (``shane_kast_red``)
   :name: instr_par-shane_kast_red
...
.. dropdown:: SHANE KASTr (``shane_kast_red_ret``)
   :name: instr_par-shane_kast_red_ret
...
.. dropdown:: SOAR blue (``soar_goodman_blue``)
   :name: instr_par-soar_goodman_blue
...
.. dropdown:: SOAR red (``soar_goodman_red``)
   :name: instr_par-soar_goodman_red
...
.. dropdown:: TNG DOLORES (``tng_dolores``)
   :name: instr_par-tng_dolores
...
.. dropdown:: VLT FORS2 (``vlt_fors2``)
   :name: instr_par-vlt_fors2
...
.. dropdown:: VLT SINFONI (``vlt_sinfoni``)
   :name: instr_par-vlt_sinfoni
...
.. dropdown:: VLT XShooter_NIR (``vlt_xshooter_nir``)
   :name: instr_par-vlt_xshooter_nir
...
.. dropdown:: VLT XShooter_UVB (``vlt_xshooter_uvb``)
   :name: instr_par-vlt_xshooter_uvb
...
.. dropdown:: VLT XShooter_VIS (``vlt_xshooter_vis``)
   :name: instr_par-vlt_xshooter_vis
...
.. dropdown:: WHT ISISb (``wht_isis_blue``)
   :name: instr_par-wht_isis_blue
...
.. dropdown:: WHT ISISr (``wht_isis_red``)
   :name: instr_par-wht_isis_red
